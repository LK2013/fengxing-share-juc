...
/**
 * 通过打印对象头，分析cas的 offset
 * @ClassName: AtomicStudentAgeUpdater
 * @package com.share.juc.cas.demo.atomic
 * @author: fengxing
...
public class AtomicStudentAgeUpdater {
    ...
    public static void main(String[] args) {
        AtomicStudentAgeUpdater updater = new AtomicStudentAgeUpdater("李磊",18);
        //打印对象头
        System.out.println(ClassLayout.parseInstance(updater).toPrintable());

        updater.compareAndSwapAge(18,56);
        System.out.println("真实的李磊年龄---"+updater.getAge());
    }
